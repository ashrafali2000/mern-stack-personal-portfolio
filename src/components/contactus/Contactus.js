              ...
              <Row>
                ...
                <Col md={7}>
                  <div className="contacts-details">
                    <a
                      href={`mailto:ashrafalikakozai9876@gmail.com`}
                    ...
                    >
                      ...
                      <p style={{ color: "#fbd9ad" }}>
                        ashrafalikakozai9876@gmail.com
                      </p>
                    </a>
                    <a
                      href={`tel:+923333894552`}
                      className="personal-details"
                    >
                      <div className="detailsIcon">
                        <FiPhone />
                      </div>
                      <p style={{ color: "#fbd9ad" }}>+923333894552</p>
                    </a>
                    <a
                    ...
                    >
                      <div className="personal-details">
                        ...
                        <p style={{ color: "#fbd9ad" }}>
                          Hasan Squair Civic Center, Karachi,
                          Pakistan.
                        </p>
                      </div>
                    </a>
